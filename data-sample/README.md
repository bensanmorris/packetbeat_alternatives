...
- hubble-flows-demo.json (3.6M)
- hubble-flows-dns.json (482)
- hubble-flows-dropped.json (23K)
- hubble-flows-http.json (482)
- hubble-stats.txt (111)

### Packetbeat Data (`packetbeat/`)
- packetbeat-combined.json (4.5M)
- packetbeat-stats.txt (3.3K)
...
**Sample generated:** Fri 17 Apr 13:42:12 BST 2026  
